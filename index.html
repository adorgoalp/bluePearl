...
<html>
    ...
    <body>
        <section>
            <div class="topbox black"></div>
            <div class="banner">
                <div class="title-and-name">
                    <h1>MASUMA SHAHORIN</h1>
                    <h2>Graphics Designer</h2>
                </div>
                <section class="single-item slider">
                    <div>
                        <img src="img/mainBanner/Banner1.jpg">
                    </div>
                    <div>
                        <img src="img/mainBanner/Banner2.jpg">
                    </div>
                    <div>
                        <img src="img/mainBanner/Banner3.jpg">
                    </div>
                    <div>
                        <img src="img/mainBanner/Banner4.jpg">
                    </div>
                    <div>
                        <img src="img/mainBanner/Banner5.jpg">
                    </div> 
                </section>
            </div>
            <div class="scrollDown" style="margin-top: -40px; position: relative;">
                <img src="img/scrollDown.png" alt="ScrollDown">
            </div>
        </section>
        <section>
            <div class="padding-cleartop"></div>
            <div class="title-and-name">
            ...
            <div class="left-right-parent">
                <div class="left">
                    <div class="centering">
                        <h2 class="grey">who am I</h2>
                        <p style="padding: 10%">
                            Hello, I am Masuma a passionate graphics designer from Dhaka, Bangladesh.<br>
                            I love to design stuff, like banner, logo, brochure, 
                            business card, flyer, X-banner, websites, mobile app etc. <br>
                            Need a job done? I am here.
                        </p>
                    </div>
                </div>
                <div class="right">
                    <h2 class="grey" style="text-align: center;">skill</h2>
                    <div class="padding-cleartop"></div>
                    <div class="parent-3-part">
                        <div class="left-3-part skillHolder">
                            <div style="text-align: center;">
                                <div class="skill moveLeft">
                                    <img src="img/skill100.png" class="skillZoom" alt="zoom">
                                    <img src="img/skillbase.png" class="skillBase" alt="base">
                                    <div class="skillText" style="left: 70px;">Photoshop</div>
                                </div>
                            </div>
                        </div>
                        <div class="middle-3-part skillHolder">
                            <div class="skill moveRight">
                                <img src="img/skill100.png" class="skillZoom" alt="zoom">
                                <img src="img/skillbase.png" class="skillBase" alt="base">
                                <div class="skillText">Illustrator</div>
                            </div>
                        </div>
                        <div class="right-3-part skillHolder">
                            <div class="skill moveRight">
                                <img src="img/skill50.png" class="skillZoom" alt="zoom">
                                <img src="img/skillbase.png" class="skillBase" alt="base">
                                <div class="skillText">Flash</div>
                            </div>
                        </div>
                    </div>
                    <div class="parent-3-part">
        ...
        <section>
            <div class="padding-cleartop"></div> <div class="padding-cleartop"></div>
        </section>
